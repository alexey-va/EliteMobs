...
- [ ] Replace the rectangular placeholders with square slots inside the existing cards. Retain Signature, Utility, Mobility ordering.
- [ ] Render the current effective abilities dynamically, including the inherited movement skill.
